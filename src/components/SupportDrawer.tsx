      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 left-0 right-0 bg-zinc-950 border-t border-brand-red/30 z-[90] h-[55vh] flex flex-col touch-none"
          >
            {/* Handle Bar */}
            ...
            <div className="px-6 py-6 space-y-6">
              <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-4">
                ...
                <textarea
                  ...
                  className="w-full bg-black border border-zinc-800 rounded-xl p-4 text-sm text-white placeholder:text-zinc-700 focus:outline-none focus:border-brand-red transition-colors resize-none h-20"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-3 p-4 bg-zinc-900 border border-zinc-800 rounded-2xl hover:border-brand-red/50 transition-all active:scale-95 group relative"
                >
                  {/* Red Badge */}
                  <div className="absolute -top-2 -right-2 w-6 h-6 bg-brand-red rounded-full flex items-center justify-center border-2 border-zinc-950 z-10">
                  ...
                  <div className="text-center">
                    <span className="block text-[8px] font-black text-zinc-500 uppercase tracking-widest leading-none mb-1">WhatsApp</span>
                    <span className="block text-sm font-black text-white italic tracking-tighter">Channel 1</span>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-center">
                    <span className="block text-[8px] font-black text-zinc-500 uppercase tracking-widest leading-none mb-1">WhatsApp</span>
                    <span className="block text-sm font-black text-white italic tracking-tighter">Channel 2</span>
                  </div>
                </button>
              </div>

              <div className="flex items-center gap-3 px-2 text-zinc-500 pt-2">
